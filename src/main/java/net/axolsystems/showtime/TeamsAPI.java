...
public class TeamsAPI {
    ...
    public static JSONObject getSettings() {
        try {
            // Construct the API URL for getting team data
            String apiUrl = API_BASE_URL + "/api/getSettings";
            URL url = new URL(apiUrl);
    ...
    public static boolean toggleGameSettingsOff() {
        try {
            // Construct the API URL for adding a new team
            String apiUrl = API_BASE_URL + "/api/toggleGameSettings";
            URL url = new URL(apiUrl);
    ...
    public static boolean toggleGameSettings(String gameID, String mapID) {
        try {
            // Construct the API URL for adding a new team
            String apiUrl = API_BASE_URL + "/api/toggleGameSettings";
            URL url = new URL(apiUrl);
